                ...
                <div class="bcontent-dwn">
                  <table width="100%">
                    <tr>
                      <td align="left">
                        <a href="r_count.php">
                          <image src="images/chat.png" width="30"/>
                        </a>';
              ...
              echo '<td align="right">
                    ...
                    <td align="right">
                      <a href="notification_count.php">
                        <image src="images/bell.png" width="30" />
                      </a>';
                    ...
                    while($m3 = mysqli_fetch_array($m1)){
                      ...
                      if($f2>0){
                        while($d = mysqli_fetch_assoc($f1)){
                          ...
                          echo '<a href="chat.php?from='.$ggtouser.'&to='.$ggfromuser.'">'.$dccfname.' '.$dccsurname.'</a><br>'.$message_text.'<br>'; 
                        }
                      }
                    }
                  }
                      ...
                      while($m3 = mysqli_fetch_array($m1)){
                        ...
                        if($f2>0){
                          while($d = mysqli_fetch_assoc($f1)){
                            $dccfname = $d['ccfname'];
                            $dccsurname = $d['ccsurname'];
                            echo '<a href="chat.php?from='.$ggfromuser.'&to='.$ggtouser.'">'.$dccfname.' '.$dccsurname.'</a><br>'.$message_text.'<br>'; 
                          }
                        }
                      }
                    }
