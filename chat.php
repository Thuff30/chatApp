        ...
        if($g2>0){
          while($dinfo = mysqli_fetch_assoc($g1)){
            ...
            if($us2>0){
              ...
              while($dy = mysqli_fetch_assoc($d1)){ 
                $fromuserP = $dy['touser']; 
                $mess = $dy['message_text']; 
                $touserP = $dy['from']; 
                if($touserP){ 
                  echo '<div align="right">
                          <p class="chat-bubble-green">'.$touserP.'
                            <br>
                            <image src="images/mark.png" width="10" />
                            <image src="images/mark.png" width="10" />'.$mess.'
                          </p>
                      </div>'; 
                }
                if($touserP){ 
                  ...
                  while($dy = mysqli_fetch_assoc($d1)){ 
                    ...
                    echo '<p class="chat-bubble">'.$touserP.'
                            <br>
                            <image src="images/mark.png" width="10" />
                            <image src="images/mark.png" width="10" />'.$messP.'
                          </p>';
                  }
                }
              }
              echo '<br>
                    ...
                    <table width="100%">
                      <tr>
                        ...
                        <td align="left">
                          <input type="text" name="message_text" class="binput5" value="" required="" placeholder="type message" />
                        </td>
                        <td align="right">
                          <button class="gt-send">
                            <b>
                            <image src="images/msend.png" width="32" />
                          </button>
                        </td>
                      </tr>
                    </table>
